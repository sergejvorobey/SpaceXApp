...
struct RocketDetail: View {
    ...
    var body: some View {
            VStack(spacing: 16) {
                ...
                RocketStage(
                    viewModel: RocketStageViewModel(
                        stageTitle: "Вторая ступень".uppercased(),
                ...
                NavigationLink(destination: LaunchView(viewModel: LaunchViewModel(rocket: viewModel.rocket)),
                               isActive: $isLaunchView) {
                }
        }
